...
KERNEL_SPECS="oneplusx;oos;oos3xx;http://kernel.boeffla.de/oneplusx/boeffla-kernel-oos/;boeffla-kernel-#VERSION#-OOS3xx-OnePlusX-anykernel.recovery.zip"
